    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('RE', 'Checked In - Ready'), ('NR', 'Checked In - Not Ready'), ('CO', 'Checked Out'), ('AW', 'Awaiting Loan Approval'), ('RT', 'Awaiting Return Approval'), ('ST', 'In Storage'), ('DM', 'Damaged'), ('RE', 'Replacement Required'), ('MI', 'Missing'), ('DE', 'Decommisioned'), ('OB', 'Obselete'), ('RS', 'Restricted Use'), ('HO', 'On Hold'), ('SE', 'Servicing')], default='RE', max_length=2, verbose_name='Device Status')),
                ...
                ('authorisation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='utils.Authorisation', verbose_name='Device Authorisation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_id', models.CharField(blank=True, max_length=45, null=True, verbose_name='Service ID')),
                ...
                ('vendor', models.CharField(blank=True, max_length=64, null=True, verbose_name='Contract Vendor')),
                ('contact', models.CharField(blank=True, max_length=128, null=True, verbose_name='Contract Contact')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
